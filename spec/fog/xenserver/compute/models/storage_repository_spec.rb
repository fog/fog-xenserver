...
describe Fog::XenServer::Compute::Models::StorageRepository do
  let(:storage_repository_class) do
    class Fog::XenServer::Compute::Models::StorageRepository
      def self.read_identity
        instance_variable_get('@identity')
      end
    end
    Fog::XenServer::Compute::Models::StorageRepository
  end

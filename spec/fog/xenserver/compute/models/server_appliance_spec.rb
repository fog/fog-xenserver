...
describe Fog::XenServer::Compute::Models::ServerAppliance do
  let(:server_appliance_class) do
    class Fog::XenServer::Compute::Models::ServerAppliance
      def self.read_identity
        instance_variable_get('@identity')
      end
    end
    Fog::XenServer::Compute::Models::ServerAppliance
  end

...
describe Fog::XenServer::Compute::Models::Server do
  let(:server_class) do
    ...
    Fog::XenServer::Compute::Models::Server
  end

  let(:server) { Fog::XenServer::Compute::Models::Server.new }
  let(:service) { Object.new }
  let(:collection) { Object.new }
  let(:vif) { Fog::XenServer::Compute::Models::Vif.new }
  let(:vbd) { Fog::XenServer::Compute::Models::Vbd.new }

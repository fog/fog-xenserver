...
describe Fog::XenServer::Compute::Models::VbdMetrics do
  let(:vbd_metrics_class) do
    class Fog::XenServer::Compute::Models::VbdMetrics
      def self.read_identity
        instance_variable_get('@identity')
      end
    end
    Fog::XenServer::Compute::Models::VbdMetrics
  end
  let(:vbd_metrics) { Fog::XenServer::Compute::Models::VbdMetrics.new }

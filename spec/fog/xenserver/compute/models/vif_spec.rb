...
describe Fog::XenServer::Compute::Models::Vif do
  let(:vif_class) do
    ...
    Fog::XenServer::Compute::Models::Vif
  end
  let(:vif) { Fog::XenServer::Compute::Models::Vif.new }
  let(:vm) { Fog::XenServer::Compute::Models::Server.new }
  ...
  describe '#set_device_number' do
    ...
    describe 'when vm is not nil' do
      ...
      describe 'and exists vifs' do
        before :each do
          @vif2 = Fog::XenServer::Compute::Models::Vif.new(:device => 2)
          @vif4 = Fog::XenServer::Compute::Models::Vif.new(:device => 4)
          vif.stub(:vm, vm) do

...
describe Fog::XenServer::Compute::Models::HostMetrics do
  let(:host_metrics_class) do
    class Fog::XenServer::Compute::Models::HostMetrics
      def self.read_identity
        instance_variable_get('@identity')
      end
    end
    Fog::XenServer::Compute::Models::HostMetrics
  end
  let(:host_metrics) { Fog::XenServer::Compute::Models::HostMetrics.new }
